...
public class SensorReading {
    ...
    public SensorReading(String thingid,
        ...
        logger.info("Created SensorReading: {}", this);
    }
    ...
    public String toString() {
        return "SensorReading{" +
                ...
                ", elbow_flex_ext_right=" + elbow_flex_ext_right +
                ", shoulder_flex_ext_left=" + shoulder_flex_ext_left +
                ", shoulder_flex_ext_right=" + shoulder_flex_ext_right +
                ", shoulder_abd_add_left=" + shoulder_abd_add_left +
                ", shoulder_abd_add_right=" + shoulder_abd_add_right +
                ", lowerarm_pron_sup_left=" + lowerarm_pron_sup_left +
                ", lowerarm_pron_sup_right=" + lowerarm_pron_sup_right +
                ", upperarm_rotation_left=" + upperarm_rotation_left +
                ", upperarm_rotation_right=" + upperarm_rotation_right +
                ", hand_flex_ext_left=" + hand_flex_ext_left +
                ", hand_flex_ext_right=" + hand_flex_ext_right +
                ", hand_radial_ulnar_left=" + hand_radial_ulnar_left +
                ", hand_radial_ulnar_right=" + hand_radial_ulnar_right +
                ", neck_flex_ext=" + neck_flex_ext +
                ", neck_torsion=" + neck_torsion +
                ", head_tilt=" + head_tilt +
                ", torso_tilt=" + torso_tilt +
                ", torso_side_tilt=" + torso_side_tilt +
                ", back_curve=" + back_curve +
                ", back_torsion=" + back_torsion +
                ", knee_flex_ext_left=" + knee_flex_ext_left +
                ", knee_flex_ext_right=" + knee_flex_ext_right +
                ", timestamp=" + timestamp +
                '}';
    }
}
