 ...
 * for publishing Eye Gaze related alerts (e.g., inattention) as JSON strings.
 */
public class EyeGazeKafkaSink {

    private static final Logger logger = LoggerFactory.getLogger(EyeGazeKafkaSink.class);

    /**
     * Creates a configured KafkaSink for Eye Gaze alerts.
     *
        ...
        try {
            KafkaSink<String> kafkaSink = KafkaSink.<String>builder()
                    ...
                    .setRecordSerializer(KafkaRecordSerializationSchema.builder()
                            .setTopic(topic)
                            .setValueSerializationSchema(new SimpleStringSchema()) // Input is JSON String
                            .build()
                    )
